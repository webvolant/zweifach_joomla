...
qq.FileUploader = function (o)
{
	...
	qq.extend(this._options, {
		...
		template:'<div class="qq-uploader">' +
			'<div class="qq-upload-button btn"><span class="qq-upload-button-caption">' + Fox.Text.get('COM_FOXCONTACT_BROWSE_FILES') + '</span></div>' +
		...
		fileTemplate:'<li>' +
			...
			'<a class="qq-upload-cancel" href="#">' + Fox.Text.get('JCANCEL') + '</a>' +
			'<span class="qq-upload-failed-text">' + Fox.Text.get('COM_FOXCONTACT_FAILED') + '</span>' +
			'<span class="qq-upload-success-text">' + Fox.Text.get('COM_FOXCONTACT_SUCCESS') + '</span>' +
			'</li>',
...
qq.extend(qq.FileUploader.prototype, {
	...
	_onComplete:function (id, fileName, result)
	{
		...
		if (result.success)
		{
			...
			span.appendChild(document.createTextNode(Fox.Text.get('COM_FOXCONTACT_REMOVE_ALT')));
			span.setAttribute("class","qq-upload-remove");
			span.setAttribute("title", Fox.Text.get('COM_FOXCONTACT_REMOVE_TITLE'));
