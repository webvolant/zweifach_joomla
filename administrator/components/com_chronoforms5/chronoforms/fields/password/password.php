...
**/
namespace GCore\Admin\Extensions\Chronoforms\Fields\Password;
/* @copyright:ChronoEngine.com @license:GPLv2 */defined('_JEXEC') or die('Restricted access');
defined("GCORE_SITE") or die;
class Password {
	static $title = 'Password Box';
	static $cat_id = 'basic';
	...
	public static function element($data = array()){
		echo \GCore\Helpers\Html::formSecStart('original_element', 'password_origin');
