...
**/
namespace GCore\Admin\Extensions\Chronoforms\Events\Enable;
/* @copyright:ChronoEngine.com @license:GPLv2 */defined('_JEXEC') or die('Restricted access');
defined("GCORE_SITE") or die;
class Enable extends \GCore\Admin\Extensions\Chronoforms\Events\Event{
	static $title = 'Enable';
	static $cat_id = 'basic';
	...
	public static function config($data = array(), $k = '{N}'){
		...
		echo \GCore\Helpers\Html::formLine('-', array('type' => 'multi', 'inputs' => array_merge(self::_fields($data, $k), array(
			array('name' => 'Form[extras][jsevents]['.$k.'][target]', 'type' => 'dropdown', 'label' => array('position' => 'top', 'text' => l_('CF_EVENT_ENABLE')), 'sublabel' => l_('CF_EVENT_ELEMENT'), 'options' => self::$fields),
		))));
